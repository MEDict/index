...
t.value=document.getElementById("down").href=document.getElementById("p").innerText;function v(a){navigator.clipboard.readText().then(function(b){w(a,b)})}function w(a,b){var d=b.replace(/[\u00A0-\u9999<>&]/g,function(c){return"&#"+c.charCodeAt(0)+";"});document.getElementById("p").innerHTML=d;fetch("https://"+document.domain+"/"+encodeURIComponent(b),{headers:{where:"here"}}).then(function(c){if(c.ok)a.target.textContent="Done!";else throw Error("Network response was not ok.");})}
